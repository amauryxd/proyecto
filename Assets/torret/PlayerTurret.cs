...
public class PlayerTurret : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        float T = parabolicshot.TiempodeVuelo(P0, V0);
    ...
    void Fire()
    {
        ...
        bullet.GetComponent<KinematicBullet2>().P0 = position;
        bullet.GetComponent<KinematicBullet2>().V0 = bulletSpeed * shootPoint.forward;
